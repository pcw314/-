    ...
    <div>
        ...
        <div v-if="props.pagination" class="table-pagination">
            <el-pagination
                ...
                :page-size="baTable.table.filter!.number"
...
const pageSizes = computed(() => {
    ...
    if (baTable.table.filter!.number) {
        if (!defaultSizes.includes(baTable.table.filter!.number)) {
            defaultSizes.push(baTable.table.filter!.number)
        }
    }
    return defaultSizes
})
