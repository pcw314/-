...
export const validatorType = {
    ...
    mobile: i18n.global.t('util.mobile'),
    idNumber: i18n.global.t('util.Id number'),
    account: i18n.global.t('util.account'),
    password: i18n.global.t('util.password'),
    varName: i18n.global.t('util.variable name'),
    editorRequired: i18n.global.t('validate.editor required'),
    url: 'URL',
    email: i18n.global.t('util.email'),
    date: i18n.global.t('util.date'),
    number: i18n.global.t('util.number'),
    integer: i18n.global.t('util.integer'),
    float: i18n.global.t('util.float'),
}
